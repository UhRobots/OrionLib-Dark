...
if not Success then
	warn("\nOrion Library - Failed to load Icons. Error code: " .. Response .. "\n");
end
...
CreateElement("Frame", function(Color)
	local Frame = Create("Frame", {BackgroundColor3=(Color or Color3.fromRGB(255, 255, 255)),BorderSizePixel=0});
	return Frame;
end);
...
CreateElement("ScrollFrame", function(Color, Width)
	local ScrollFrame = Create("ScrollingFrame", {BackgroundTransparency=1,MidImage="rbxassetid://7445543667",BottomImage="rbxassetid://7445543667",TopImage="rbxassetid://7445543667",ScrollBarImageColor3=Color,BorderSizePixel=0,ScrollBarThickness=Width,CanvasSize=UDim2.new(0, 0, 0, 0)});
	return ScrollFrame;
end);
...
OrionLib.MakeWindow = function(self, WindowConfig)
	...
	AddConnection(CloseBtn.MouseButton1Up, function()
		...
		UIHidden = true;
		OrionLib:MakeNotification({Name="UI Hidden",Content="Press Right Shift to reopen the UI",Time=5});
